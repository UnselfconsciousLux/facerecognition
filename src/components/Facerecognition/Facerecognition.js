...
var FaceRecognition = ({box, imageUrl}) => {
	...
	console.log('this is the box array coming in from App.Js ',box)
	...
	return (
		<div className='center ma'>
			<div className='absolute mt3'>
				...
				<div className = 'bounding_box' style = {{top: topRow, right: rightCol, bottom: bottomRow, left: leftCol }}></div>
			</div>
		</div>
	);
}
